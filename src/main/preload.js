...
contextBridge.exposeInMainWorld('gitNoteApi', {
  ...
  listRepos: () => invoke(IPC_CHANNELS.LIST_REPOS),
  addRepo: (payload) => invoke(IPC_CHANNELS.ADD_REPO, payload),
  updateRepo: (payload) => invoke(IPC_CHANNELS.UPDATE_REPO, payload),
  removeRepo: (payload) => invoke(IPC_CHANNELS.REMOVE_REPO, payload),
  switchRepo: (payload) => invoke(IPC_CHANNELS.SWITCH_REPO, payload),
  ...
  restoreEntry: (payload) => invoke(IPC_CHANNELS.RESTORE_ENTRY, payload),
  purgeEntry: (payload) => invoke(IPC_CHANNELS.PURGE_ENTRY, payload),
  openExternalFile: (payload) => invoke(IPC_CHANNELS.OPEN_EXTERNAL_FILE, payload),
  pasteImage: (payload) => invoke(IPC_CHANNELS.PASTE_IMAGE, payload),
  syncNow: () => invoke(IPC_CHANNELS.SYNC_NOW),
  pullNow: () => invoke(IPC_CHANNELS.PULL_NOW),
